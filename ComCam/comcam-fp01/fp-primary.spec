...
TSTAND      String  EOCCv0_TUS                  Test Stand
...
LSST_NUM    String  ${focal-plane/RAFT/CCD/name} LSST Assigned CCD Number
...
CCDTEMP     Float   ${focal-plane/RAFT/CCD/Temp} Measured temperature (deg C)
